...
public class WaterPouring3 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i <= 19; i++) System.out.println(wp3.solve(i));
        WaterPouring3 wp = new WaterPouring3(2, 5, 5);
        for (int i = 0; i <= 13; i++) System.out.println(wp.solve(i));
    ...
    class Path {
        ...
        public boolean contains(int target) {
            int som = endState.stream().collect(Collectors.summingInt(e -> e));
            return som == target;
        }
        //-------------------------------------
        @Override
   ...
   //********************************************************************
    ...
    public String solve(int target) {
        ...
        String s3 = "-------------------------\n";
        int max = volumes.stream().collect(Collectors.summingInt(e -> e));
        if (target > max) {
